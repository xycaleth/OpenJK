...
int GLSL_LoadGPUShaders(void)
{
	...
	for (i = 0; i < GENERICDEF_COUNT; i++)
	{
		...
		if (!GLSL_BeginLoadGPUShader(&tr.genericShader[i], "generic", attribs, qtrue, extradefines, InitUniformsForGenericShader, fallbackShader_generic_vp, fallbackShader_generic_fp))
		{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.textureColorShader, "texturecolor", attribs, qtrue, NULL, InitUniformsForTextureColorShader, fallbackShader_texturecolor_vp, fallbackShader_texturecolor_fp))
	{
	...
	for (i = 0; i < FOGDEF_COUNT; i++)
	{
		...
		if (!GLSL_BeginLoadGPUShader(&tr.fogShader[i], "fogpass", attribs, qtrue, extradefines, NULL, fallbackShader_fogpass_vp, fallbackShader_fogpass_fp))
		{
	...
	for (i = 0; i < DLIGHTDEF_COUNT; i++)
	{
		...
		if (!GLSL_BeginLoadGPUShader(&tr.dlightShader[i], "dlight", attribs, qtrue, extradefines, InitUniformsForDlightShader, fallbackShader_dlight_vp, fallbackShader_dlight_fp))
		{
	...
	for (i = 0; i < LIGHTDEF_COUNT; i++)
	{
		...
		if (!GLSL_BeginLoadGPUShader(&tr.lightallShader[i], "lightall", attribs, qtrue, extradefines, InitUniformsForLightAllShader, fallbackShader_lightall_vp, fallbackShader_lightall_fp))
		{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.shadowmapShader, "shadowfill", attribs, qtrue, extradefines, NULL, fallbackShader_shadowfill_vp, fallbackShader_shadowfill_fp))
	{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.pshadowShader, "pshadow", attribs, qtrue, extradefines, InitUniformsForPShadowShader, fallbackShader_pshadow_vp, fallbackShader_pshadow_fp))
	{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.down4xShader, "down4x", attribs, qtrue, extradefines, InitUniformsFor4xDownscaleShader, fallbackShader_down4x_vp, fallbackShader_down4x_fp))
	{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.bokehShader, "bokeh", attribs, qtrue, extradefines, InitUniformsForBokehShader, fallbackShader_bokeh_vp, fallbackShader_bokeh_fp))
	{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.tonemapShader, "tonemap", attribs, qtrue, extradefines, InitUniformsForTonemapShader, fallbackShader_tonemap_vp, fallbackShader_tonemap_fp))
	{
	...
	for (i = 0; i < 2; i++)
	{
		...
		if (!GLSL_BeginLoadGPUShader(&tr.calclevels4xShader[i], "calclevels4x", attribs, qtrue, extradefines, InitUniformsForCalcLevels4xShader, fallbackShader_calclevels4x_vp, fallbackShader_calclevels4x_fp))
		{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.shadowmaskShader, "shadowmask", attribs, qtrue, extradefines, InitUniformsForShadowMaskShader, fallbackShader_shadowmask_vp, fallbackShader_shadowmask_fp))
	{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.ssaoShader, "ssao", attribs, qtrue, extradefines, InitUniformsForSSAOShader, fallbackShader_ssao_vp, fallbackShader_ssao_fp))
	{
	...
	for (i = 0; i < 2; i++)
	{
		...
		if (!GLSL_BeginLoadGPUShader(&tr.depthBlurShader[i], "depthBlur", attribs, qtrue, extradefines, InitUniformsForDepthBlurShader, fallbackShader_depthblur_vp, fallbackShader_depthblur_fp))
		{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.gaussianBlurShader[0], "gaussian_blur", attribs, qtrue, extradefines, NULL, fallbackShader_gaussian_blur_vp, fallbackShader_gaussian_blur_fp))
	{
	...
	if (!GLSL_BeginLoadGPUShader(&tr.gaussianBlurShader[1], "gaussian_blur", attribs, qtrue, extradefines, NULL, fallbackShader_gaussian_blur_vp, fallbackShader_gaussian_blur_fp))
	{
