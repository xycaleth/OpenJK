/*
    ...
    OpenGL loader generated by glad 0.1.34 on Sat Dec 19 14:00:17 2020.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.3" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_debug_output,GL_ARB_texture_compression,GL_ARB_texture_filter_anisotropic,GL_EXT_texture_compression_s3tc"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.3&extensions=GL_ARB_debug_output&extensions=GL_ARB_texture_compression&extensions=GL_ARB_texture_filter_anisotropic&extensions=GL_EXT_texture_compression_s3tc
*/
...
static int get_exts(void) {
    ...
    if(max_loaded_major < 3) {
        ...
        num_exts_i = 0;
        qglGetIntegerv(GL_NUM_EXTENSIONS, &num_exts_i);
        if (num_exts_i > 0) {
